      ...
      projects: [
        {
          ...
          highlights: [
            "Judge pipeline with 6 scoring metrics and per-criterion LLM isolation to eliminate anchoring bias.",
            "YAML-based SKILL.md metric system for domain eval; agentic Metric Builder with Groq Llama-4 + LangGraph.",
        ...
        },
        {
          ...
          highlights: [
            "Groq STT → LangGraph agent → ElevenLabs TTS with Azure multilingual speech assessment.",
            "Multi-tiered prompt system with Pydantic output — cut cost & latency by 30%.",
            "FastAPI + PostgreSQL + Redis + GKE; Prometheus + Grafana monitoring.",
          ],
        ...
        },
        {
          ...
          highlights: [
            "Hybrid retrieval with Qdrant dense + sparse keyword search for code and docs.",
            "Neo4j code graph traversal to surface related functions and dependency chains.",
            "Evaluated with Ragas; chunking, metadata, and prompt experiments for better grounding.",
          ],
        ...
        },
        {
          ...
          highlights: [
            "Spark ETL with PostgreSQL CDC via Debezium and Kafka for real-time merchant event streaming.",
            "Flink streaming on GKE with Terraform, Helm, and Jenkins CI/CD.",
            "Observability with Prometheus, Grafana, and ELK stack.",
          ],
      ...
      projects: [
        {
          ...
          highlights: [
            "Pipeline judge với 6 metric chấm điểm và LLM isolation theo từng tiêu chí.",
            "SKILL.md metric YAML theo domain; Metric Builder tác tử với Groq Llama-4 + LangGraph.",
            "Dashboard React + TypeScript, Recharts analytics, storage cloud-agnostic.",
          ],
          stack: "LangGraph, Groq Llama-4, Langfuse, FastAPI, React, TypeScript, Recharts, MinIO",
          imgUrl: projImg2,
          projectUrl: "https://github.com/abcdefya",
        ...
        },
        {
          ...
          highlights: [
            "Groq STT → LangGraph agent → ElevenLabs TTS + Azure speech assessment đa ngôn ngữ.",
            "Hệ thống prompt đa tầng với Pydantic output — giảm 30% chi phí & độ trễ.",
            "FastAPI + PostgreSQL + Redis + GKE; Prometheus + Grafana monitoring.",
          ],
          stack: "Groq STT, LangGraph, ElevenLabs, Azure Speech, FastAPI, PostgreSQL, Redis, Docker, GKE",
          imgUrl: projImg1,
        ...
        },
        {
          ...
          highlights: [
            "Hybrid retrieval: Qdrant vector dày + tìm kiếm từ khóa thưa cho code và docs.",
            "Neo4j duyệt đồ thị mã nguồn; so sánh vector RAG vs GraphRAG.",
            "Đánh giá với Ragas; thử nghiệm chunking, metadata và prompt.",
          ],
          stack: "LangChain, OpenAI API, Neo4j, Qdrant, Ollama, FastAPI, React",
          imgUrl: projImg2,
          projectUrl: "https://github.com/abcdefya",
        ...
        },
        {
          ...
          highlights: [
            "Spark ETL với PostgreSQL CDC qua Debezium và Kafka, stream sự kiện merchant thời gian thực.",
            "Flink streaming trên GKE với Terraform, Helm và Jenkins CI/CD.",
            "Observability với Prometheus, Grafana và ELK stack.",
          ],
          stack: "Spark, PostgreSQL, Debezium, Kafka, Flink, GKE, Terraform, Helm, Jenkins, Prometheus, Grafana, ELK",
          imgUrl: projImg1,
          projectUrl: "https://github.com/abcdefya/binance-merchant-trade-flow",
